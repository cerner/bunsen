...
public class ValueSetUdfsTest {
  ...
  private static SparkRowConverter observationRowConverter =
      SparkRowConverter.forResource(FhirContexts.forStu3(), "Observation");

  private static SparkRowConverter conditionRowConverter =
      SparkRowConverter.forResource(FhirContexts.forStu3(), "Condition");

  private static SparkRowConverter encounterRowConverter =
      SparkRowConverter.forResource(FhirContexts.forStu3(), "Encounter");
  ...
  public static void setUp() throws IOException {
    ...
    MockValueSets mockValueSets = MockValueSets.createWithTestValue(spark, valueSetRowConverter);
    ...
    Dataset<Row> loincObservations = observationRowConverter.toDataFrame(spark,
        ImmutableList.of(
    ...
    Dataset<Row> conditions = conditionRowConverter.toDataFrame(spark,
        ImmutableList.of(
    ...
    Dataset<Row> encounters = encounterRowConverter.toDataFrame(spark,
        ImmutableList.of(
